...
#define WIFISSID "OnePlus 12" // Enter WifiSSID here
#define PASSWORD "k4prhc58" // Enter password here
#define TOKEN "BBUS-lJWPlzBxoNCxzHfNSJkd8Dr6xzGnqa" // Ubidots' TOKEN
#define MQTT_CLIENT_NAME "aniketsarkar" // MQTT client Name
// * Define Constants
